package NumericFieldDataTypes.ByteDemo.Documents;

import KeywordDemo.Documents.IDocumentWithId;
import java.util.Objects;

/**
 * A sample document that contains a byte field for testing byte field type functionality.
 * The byte field represents stock quantity, which can range from -128 to 127.
 */
public class ProductDocument implements IDocumentWithId {
     ...
     * @param stock The product stock quantity (byte: -128 to 127)
     */
    public ProductDocument(int id, String name, byte stock) {
     ...
     * This byte property will be mapped as a byte field type in OpenSearch.
     *
